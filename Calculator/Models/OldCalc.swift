...
/// old working version of calculator class
/*
 ...
 return formattedNumberString(forNumber: number, isNegative: isNegative,
 decimalPressed: decimalPressed, zerosTrailingDecimal:
 zerosTrailingDecimal, withCommas: true)
 }
